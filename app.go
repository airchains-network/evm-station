...
var (
	_ runtime.AppI            = (*EvmStationApp)(nil)
	_ servertypes.Application = (*EvmStationApp)(nil)
)

// EvmStationApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.

type EvmStationApp struct {
	*runtime.App
...
func (app *EvmStationApp) Name() string { return app.BaseApp.Name() }

// LegacyAmino returns EvmStationApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *EvmStationApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

func (app *EvmStationApp) kvStoreKeys() map[string]*storetypes.KVStoreKey {
...
func (app *EvmStationApp) SimulationManager() *module.SimulationManager {
	return nil
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *EvmStationApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *EvmStationApp) Close() error {

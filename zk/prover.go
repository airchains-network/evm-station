...
type MyCircuit struct {
	To              [podSize]frontend.Variable `gnark:",public"`
	From            [podSize]frontend.Variable `gnark:",public"`
	Amount          [podSize]frontend.Variable `gnark:",public"`
	TransactionHash [podSize]frontend.Variable `gnark:",public"`
	FromBalances    [podSize]frontend.Variable `gnark:",public"`
	ToBalances      [podSize]frontend.Variable `gnark:",public"`
}
...
func GenerateProof(inputData types.BatchStruct, batchNum int) (any, string, []byte, error) {
	...
	if inputValueLength < podSize {
		leftOver := podSize - inputValueLength
	...
	inputs := MyCircuit{
		To:              [podSize]frontend.Variable{},
		From:            [podSize]frontend.Variable{},
		Amount:          [podSize]frontend.Variable{},
		TransactionHash: [podSize]frontend.Variable{},
		FromBalances:    [podSize]frontend.Variable{},
		ToBalances:      [podSize]frontend.Variable{},
	}

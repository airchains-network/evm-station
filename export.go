...
// file.
func (app *EvmStationApp) ExportAppStateAndValidators(forZeroHeight bool,
...
func (app *EvmStationApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) {
